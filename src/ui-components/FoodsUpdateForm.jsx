...
export default function FoodsUpdateForm(props) {
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp ? await DataStore.query(Foods, idProp) : foods;
      setFoodsRecord(record);
    };
    queryData();
  }, [idProp, foods]);
  React.useEffect(resetStateValues, [foodsRecord]);
  const validations = {
    name: [],
    description: [],
    uid: [],
